...
| [Claude Code](https://claude.ai/code) | Anthropic's terminal-first coding agent — deep context, planning, agentic workflows | macOS, Linux |
| [Codex](https://chatgpt.com/codex) | OpenAI's AI coding agent — CLI-first, multi-file edits, autonomous mode | macOS, Win, Linux |
